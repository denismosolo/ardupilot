...
public:
    ///constructor
    AC_Acro(const AP_InertialNav& inav, const AP_AHRS_View& ahrs, AC_PosControl& pos_control); //devo prendere i vari valori tra cui anche il valore della figura da eseguire?
    ...
    float get_altitude_error(uint16_t trick);
